...
interface AssetMonthlyTotalsChartProps {
  data: MonthlyTotal[]
}
...
export function AssetMonthlyTotalsChart({ data }: AssetMonthlyTotalsChartProps) {
  const points = toChartPoints(data)

  return (
    <div className="h-72" data-testid="asset-monthly-totals-chart">
